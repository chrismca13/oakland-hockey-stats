...
To solve these problems, we created a python script that scrapes career statistics for all players going back to 2007 and plugs the dataset into Tableau. The dashboard is saved in Power BI workspace here:
